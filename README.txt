Thank you for looking over this project. 

In order to run this project, download the repo to a workspace. 

If you do NOT have NODE.js on your computer, download it here https://nodejs.org/en/download/
  Also install NPM (Node Package Manager) on the command line with npm-install.
